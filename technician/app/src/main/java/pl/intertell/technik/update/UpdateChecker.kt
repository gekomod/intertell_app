package pl.intertell.technik.update
...
/**
 * Checks the GitHub Releases API for a newer technician-app build than the
 * one currently installed. There's no Play Store distribution for this app —
 * it ships as a debug APK via GitHub Releases (see .github/workflows/build-apk.yml,
...
object UpdateChecker {
    ...
    private const val ASSET_NAME = "intertell-technician-debug.apk"
